...
const EditResource = () => {
  ...
  useEffect(() => {
    if (resource) {
      ...
      setPricing(resource.price);
      setLevel("AP");
      setYear("1");
      setModule(resource.tags?.[0] || "");
      ...
      <div className="flex-1 p-8">
        <div className="bg-gray-100 p-6 rounded mb-8">
          ...
          <h2 className="text-3xl font-bold text-black">
            Edit <span className="text-blue-600">Resource</span>
          </h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-4 mt-6">
            <button
              type="button"
              className="px-6 py-3 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 text-lg"
            >
              Cancel
            </button>
            <button
